...
%>
<font color="#ff0000">
WARNING: Out of the box, the sample consumer key used by these samples has been configured to work on a host of "<b>http://localhost:9090/</b>". It looks like you are using a URL of "<b><%=request.getRequestURL()%></b>", which will not work, as MySpace requires your application's realm to first be registered.  To get these samples working, please first re-configure your app server to use the correct host.  Ultimately, you will need to create and configure your own applications at the <a href='http://developer.myspace.com'>MySpace developer site</a> using <a href='http://developerwiki.myspace.com/index.php?title=How_to_Set_Up_a_New_Application_for_OpenID'>the instructions here</a>.
</font>
<%
}
%>
