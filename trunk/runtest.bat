...
rem java -classpath "lib/json_simple-1.1.jar;build" -Dhttp.proxyHost=localhost -Dhttp.proxyPort=8888 com.myspace.myspaceid.PortableContactsTest %1 %2 %3 %4 %5 %6
